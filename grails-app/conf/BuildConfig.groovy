...
grails.project.dependency.resolution = {
    ...
    dependencies {
        ...
        // Adding explictly here so it will be included in projects that use core-web
        compile(group:'com.netflix.archaius', name:'archaius-core', version:'0.6.3')
